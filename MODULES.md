...
- [2] A public API with 5 endpoints (GET | POST | PUT | DELETE)

- [1] Use ORM for the database 

- [1] Custom-made design system 10 components (fonts | icons | colors | typogrophy)
...
- [1] Remote authentication (Google / GitHub)
