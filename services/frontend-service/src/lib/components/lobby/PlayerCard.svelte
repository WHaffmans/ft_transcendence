<script lang="ts">
	...
	const styling = $derived(() => {
		...
		// player is on the game canvas -> "ready"
		if (scene === "game") {
			return {
...
>
	...
	{#if String(player.id) === String($userStore?.id)}
		<div
	...
	<div class="flex flex-col items-center gap-2">
		...
		<!-- Status Badge -->
		<div
			class="{styling().badgeBg} h-6 rounded-xl px-5 flex items-center justify-center"
		>
